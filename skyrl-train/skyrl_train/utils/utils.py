...
def initialize_ray(cfg: DictConfig):
    ...
    ray.init(
        runtime_env={
            "env_vars": env_vars,
            # This hook is intentionally a top-level, dependency-light module.
            # Importing skyrl_train here imports torch before Ray applies the
            # actor's CUDA mask, which can latch every actor onto GPU 0.
            "worker_process_setup_hook": "skyrl_train_worker_setup.force_stock_asyncio_in_worker",
        }
    )
