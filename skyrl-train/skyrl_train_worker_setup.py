...
Keep it outside the :mod:`skyrl_train` package and free of torch/transformers/ray
imports so CUDA cannot be initialized against the driver's device view first.
"""
